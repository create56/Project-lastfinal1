	...
	<div class="container">
		...
		<section class="reservation_form">
			<div class="reservation_box">
				<span class="reservation_content1"> <img src="images/icon9.jpg"> <a href="ticket-check.html">
						<button>예약 조회</button>
				</a>
				</span> <img src="images/listicon.png"> <span class="reservation_content2"> <img src="images/icon7.jpg"> <a href="check-in.html">
						<button>체크인</button>
				</a>
				</span> <img src="images/listicon.png"> <span class="reservation_content3"> <img src="images/icon8.jpg"> <a href="travel.html">
						<button>여행 정보</button>
				</a>
				</span>
			</div>
